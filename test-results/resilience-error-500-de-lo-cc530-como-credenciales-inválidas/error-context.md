...
- Name: resilience.spec.ts >> error 500 de login no se presenta como credenciales inválidas
- Location: e2e-chaos/resilience.spec.ts:50:1
...
Locator: getByText(/servidor|intentar más tarde|interno/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/servidor|intentar más tarde|interno/i)
