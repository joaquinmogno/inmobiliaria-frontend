...
export const PERMISSION_GROUPS: Array<{ title: string; permissions: PermissionKey[] }> = [
  ...
  { title: "Configuración", permissions: ["configuracion.perfil.ver", "configuracion.perfil.editar", "configuracion.backups.ver", "configuracion.backups.crear", "configuracion.backups.eliminar", "configuracion.backups.descargar", "configuracion.auditoria.ver"] },
